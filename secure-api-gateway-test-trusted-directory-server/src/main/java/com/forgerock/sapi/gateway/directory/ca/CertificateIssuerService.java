 ...
 */
package com.forgerock.sapi.gateway.directory.ca;
 ...
 * <p>
 * Certificates are signed by the directory's own CA and embedded in
...
public class CertificateIssuerService {
     ...
     * Used in the Subject DN as {@code OID.2.5.4.97=<PSD2 organisation identifier>},
     * e.g. {@code PSDGB-FCA-123456}.
     */
    ...
    private KeyPair generateKeyPair(final CertificateOptions options) {
        try {
            ...
            final KeyPairGenerator keyPairGenerator = KeyPairGenerator.getInstance(algorithmType.name(),
                    BouncyCastleProviderHolder.PROVIDER);
    ...
    private X509Certificate createCertificate(final KeyPair keyPair, final String organisationId,
        ...
        BigInteger issuedCertSerialNum = new BigInteger(128, SECURE_RANDOM);
        PKCS10CertificationRequestBuilder p10Builder =
                new JcaPKCS10CertificationRequestBuilder(issuedCertSubject, keyPair.getPublic());
        JcaContentSignerBuilder csrBuilder =
                new JcaContentSignerBuilder(certificateSigningAlg).setProvider(BouncyCastleProviderHolder.PROVIDER);
        ...
        try {
            ...
            X509Certificate issuedCert = new JcaX509CertificateConverter()
                    .setProvider(BouncyCastleProviderHolder.PROVIDER).getCertificate(issuedCertHolder);
            issuedCert.verify(caCertificate.getPublicKey(), BouncyCastleProviderHolder.PROVIDER);
            return issuedCert;
