...
public class SsaSigningService {
     ...
     * Infrastructure concerns (keystore loading) are handled by
     * {@link com.forgerock.sapi.gateway.test.trusted.directory.config.TrustedDirectoryServices}.
     *
     ...
     */
    public SsaSigningService(final PrivateKey signingPrivateKey, final String keyId, final JWKSet publicJwks) {
     ...
     */
    public String sign(final Map<String, Object> claimsMap) throws Exception {
