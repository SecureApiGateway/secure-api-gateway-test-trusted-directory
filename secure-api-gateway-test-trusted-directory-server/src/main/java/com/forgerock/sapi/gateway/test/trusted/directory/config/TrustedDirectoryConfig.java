...
public record TrustedDirectoryConfig(
    ...
    public static final String DEFAULT_ISSUER_NAME = "SAPI-G Test Trusted Directory";
    public static final String DEFAULT_FQDN = "localhost:8080";
    public static final String DEFAULT_STORAGE_FILE_PATH = "/var/ttd/trusted-directory-jwks.json";
    public static final String DEFAULT_KEYSTORE_TYPE = "PKCS12";
    public static final String DEFAULT_SIGNING_KEY_ALIAS = "jwt-signing";
    public static final String DEFAULT_CA_KEY_ALIAS = "ca";
