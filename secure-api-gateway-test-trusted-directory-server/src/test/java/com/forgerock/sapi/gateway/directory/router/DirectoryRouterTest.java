...
class DirectoryRouterTest {
    ...
    @Test
    void shouldReturnPublicDirectoryJwks() throws Exception {
        ...
        var publicJwks = new org.forgerock.json.jose.jwk.JWKSet(List.of(sigKey));
    ...
    @Test
    void shouldReturn500WhenDirectoryJwksServiceThrows() throws Exception {
